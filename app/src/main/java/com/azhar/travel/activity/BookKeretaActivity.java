...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Tunangan", "Akad", "Prewedd", "Posewedd", "Kosong"};
        final String[] tujuan = {"Tunangan", "Akad", "Prewedd", "Posewedd", "Kosong"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("Tunangan") && sTujuan.equalsIgnoreCase("Tunangan"))
                            || (sAsal.equalsIgnoreCase("Akad") && sTujuan.equalsIgnoreCase("Akad"))
                            || (sAsal.equalsIgnoreCase("Prewedd") && sTujuan.equalsIgnoreCase("Prewedd"))
                            || (sAsal.equalsIgnoreCase("Posewedd") && sTujuan.equalsIgnoreCase("posewedd"))
                            || (sAsal.equalsIgnoreCase("Kosong") && sTujuan.equalsIgnoreCase("Kosong"))) {
                        Toast.makeText(BookKeretaActivity.this, "Paket dan Tambahan tidak boleh sama !", Toast.LENGTH_LONG).show();
                    } else {
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("Tunangan") && sTujuan.equalsIgnoreCase("Akad")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Tunangan") && sTujuan.equalsIgnoreCase("Prewedd")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Tunangan") && sTujuan.equalsIgnoreCase("Posewedd")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("Tunangan") && sTujuan.equalsIgnoreCase("Kosong")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("Akad") && sTujuan.equalsIgnoreCase("Tunangan")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("Akad") && sTujuan.equalsIgnoreCase("Prewedd")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Akad") && sTujuan.equalsIgnoreCase("Posewedd")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Akad") && sTujuan.equalsIgnoreCase("Kosong")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("Prewedd") && sTujuan.equalsIgnoreCase("Tunangan")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Prewedd") && sTujuan.equalsIgnoreCase("Akad")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("Prewedd") && sTujuan.equalsIgnoreCase("Posewedd")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("Prewedd") && sTujuan.equalsIgnoreCase("Kosong")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("Posewedd") && sTujuan.equalsIgnoreCase("Tunangan")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("Posewedd") && sTujuan.equalsIgnoreCase("Akad")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("Posewedd") && sTujuan.equalsIgnoreCase("Kosong")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("Posewedd") && sTujuan.equalsIgnoreCase("Prewedd")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("Kosong") && sTujuan.equalsIgnoreCase("Tunangan")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("Kosong") && sTujuan.equalsIgnoreCase("Akad")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("Kosong") && sTujuan.equalsIgnoreCase("Posewedd")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("Kosong") && sTujuan.equalsIgnoreCase("Prewedd")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        }

...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking untuk pemesanan paket " + asal + " dan " + tujuan + " pada tanggal " + tanggal + ". " +
                    "Jumlah pemesanan hari adalah " + dewasa + " dan fotografer sebanyak " + anak + ".";
